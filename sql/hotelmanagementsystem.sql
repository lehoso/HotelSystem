...
CREATE TABLE `customer`  (
  `customer_id` int NOT NULL AUTO_INCREMENT COMMENT '用户唯一标识符',
...
CREATE TABLE `employee`  (
  `employee_id` int NOT NULL AUTO_INCREMENT COMMENT '唯一标志号',
...
-- Records of hotel
-- ----------------------------
INSERT INTO `hotel` VALUES ('重庆市永川区', '公交128路可以直达！', '当当大酒店', '永川地区最舒适最实惠的酒店之一');
...
CREATE TABLE `orders`  (
  ...
  `record_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '记录生成时间，可以是预定时间或者是入住时间',
  `start_time` datetime NULL DEFAULT NULL COMMENT '入住开始时间',
  ...
  CONSTRAINT `fk1` FOREIGN KEY (`room_number`) REFERENCES `room` (`room_number`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`username`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (2, '302', '2021-12-30 21:55:50', '2021-12-31 00:00:00', '2022-01-01 00:00:00', 'admin222', '413605200808083654', '葫芦娃二号', '预定', '单人间', NULL);
...
CREATE TABLE `question`  (
  ...
  `send_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '消息发送时间',
...
CREATE TABLE `roomcategory`  (
  `roomcategory_id` int NOT NULL AUTO_INCREMENT,
  ...
  `locked_number` int NULL DEFAULT NULL,
  `inuse_roomnumber` int NULL DEFAULT NULL,
